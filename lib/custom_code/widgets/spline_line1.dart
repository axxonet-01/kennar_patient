...
class SplineLine1 extends StatefulWidget {
  const SplineLine1({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  _SplineLine1State createState() => _SplineLine1State();
}
...
class _SplineLine1State extends State<SplineLine1> {
            ...
            child: SfCartesianChart(
              ...
              series: <ChartSeries>[
                LineSeries<ChartData, String>(
                  ...
                  legendItemText: 'HDL cholesterol',
                ...
                LineSeries<ChartData, String>(
                  ...
                  legendItemText: 'LDL cholesterol',
                  markerSettings: MarkerSettings(
                    isVisible: true,
