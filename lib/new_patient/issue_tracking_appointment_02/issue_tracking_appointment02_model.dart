...
import 'issue_tracking_appointment02_widget.dart'
...
class IssueTrackingAppointment02Model
    extends FlutterFlowModel<IssueTrackingAppointment02Widget> {
  ...
  // State field(s) for DropDown_app_type widget.
  String? dropDownAppTypeValue;
  FormFieldController<String>? dropDownAppTypeValueController;
