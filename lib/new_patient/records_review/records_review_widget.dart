...
import 'records_review_model.dart';
export 'records_review_model.dart';

class RecordsReviewWidget extends StatefulWidget {
  const RecordsReviewWidget({super.key});

  @override
  State<RecordsReviewWidget> createState() => _RecordsReviewWidgetState();
}

class _RecordsReviewWidgetState extends State<RecordsReviewWidget> {
  late RecordsReviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecordsReviewModel());
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SelectionArea(
                                    child: Text(
                                  'The records retrieval from ${FFAppState().facilityname}was successfully!  We will now be redirecting you to______Hospital',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
